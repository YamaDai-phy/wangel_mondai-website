CREATE TABLE submissions_new (
  ...
  doc_type TEXT NOT NULL CHECK (doc_type IN ('question', 'answer', 'past_exam', 'incomplete')),
...
INSERT INTO submission_comments_new
SELECT id, submission_id, author, body, created_at FROM submission_comments;
